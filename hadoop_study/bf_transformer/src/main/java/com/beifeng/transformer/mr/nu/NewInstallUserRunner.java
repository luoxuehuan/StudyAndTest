...
public class NewInstallUserRunner extends TransformerBaseRunner {
    ...
    public static void main(String[] args) {
        ...
        runner.setupRunner("new_install_user", 
        		NewInstallUserRunner.class, //setJarByClass runner类
        		NewInstallUserMapper.class, 	//mapper类
        		NewInstallUserReducer.class,  //reducer类
        		StatsUserDimension.class, //mapper 的输出key
        		TimeOutputValue.class, 	//mapper的 输出value
        		StatsUserDimension.class,  //reduce的 输出key
        		MapWritableValue.class);//reduce的输出value
        try {
