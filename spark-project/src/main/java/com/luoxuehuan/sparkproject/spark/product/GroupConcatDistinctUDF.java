 ...
 *
 */
public class GroupConcatDistinctUDF extends UserDefinedAggregateFunction {
	...
	public void update(MutableAggregationBuffer buffer, Row input) {
		...
		//在这里要实现去重的逻辑
		//判断 之前没有拼接过来的某个城西信息，那么这里才可以接下去拼接新的城市信息
